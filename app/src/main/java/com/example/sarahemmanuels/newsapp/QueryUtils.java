    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String webTitle = response.optString("webTitle");
                String url = response.optString("webUrl");
                String date = response.optString("webPublicationDate");
                String section = response.optString("sectionName");
                ...
                News news = new News(webTitle, author, url, date, section);
